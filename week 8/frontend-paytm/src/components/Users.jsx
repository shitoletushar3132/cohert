    ...
    <div>
      <form class="max-w-md mx-auto">
        ...
        <div class="relative">
          ...
          <button
            type="submit"
            class="text-white absolute end-2.5 bottom-2.5 bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm px-4 py-2"
          >
            Search
          </button>
        </div>
      </form>
      <div className="flex justify-between items-center mt-10 shadow-sm rounded-md px-3">
